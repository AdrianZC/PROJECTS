...
var balance;  // initial value
var die1Image = new Image();
var die2Image = new Image();

function getUserInput() {
  balance = prompt("How much money would you like to add?");
  document.getElementById("balance").textContent = "You have: $" + balance;
}
...
function whoWon() {
    ...
    document.querySelector("h3").innerHTML = banner + "<br>" + outcome + "<br>" + "<br>"+ "You have: $" + balance + " left.";
  }
